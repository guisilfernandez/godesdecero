...
func MuestroSlice() {
	...
	porcion2 := arreglo[:5]  //slice creado desde un vecttor, desde la posición 0 hasta la 5
	porcion3 := arreglo[6:7] //Slice creado desde un vector, desde la posición 6 a la 7
